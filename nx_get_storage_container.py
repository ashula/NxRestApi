#
#    Module: nx_get_storage_container.py
#
#    Ver-0.01: 19Jan2018, Initial implementation to get storage_container info.  from nx_get_vmdisk.py
...
#
#    func. nx_get_storage_container()
#    func. nx_get_storage_container_by_uuid()
...
if (__name__=='__main__'):
    ...
    argc, argv=get_argv.get_argv(3)
    VIP=argv[1]
    UUID=argv[2]

    r=nx_get_storage_containers(VIP)
    ...
    r=nx_get_storage_container_by_uuid(VIP,UUID)
    print "%s" % r.text
