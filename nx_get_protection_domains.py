#
#    Module: nx_get_protection_domainw.py
#
#    Ver-0.01: 07Nov2017, initial nx_get_protection_domains.py from nx_get_image.py Ver-0.05.
...
#
#    $ python ./nx_get_protection_domains.py  VIP 
#
#    return REST api
#
import os
...
def  nx_get_protection_domains(VIP):
...
#    VIP = '172.16.2.109'
    ...
    r=nx_get_protection_domains(VIP)
